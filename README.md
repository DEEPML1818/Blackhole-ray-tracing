...
equations are included as a stepping stone (pg 1-31) to understanding the more difficult decomposition in general relativity (pg 32-57)
...
**Please see** [numerical_relativity_theory_notes.pdf](numerical_relativity_theory_notes.pdf) for full explanation. Refer to pg 32-41.
...
For the theory behind this calculation see [numerical_relativity_theory_notes.pdf](numerical_relativity_theory_notes.pdf). Refer to pg 41-57
...
## 🚀 Google Colab Quickstart (No Local Setup Required)

You can run the entire simulation suite (GRRT ray tracing, interactive studio, puncture initial data solver, and horizon plunge video rendering) directly in Google Colab:

- **Notebook**: [`black_hole_ray_tracing_colab.ipynb`](black_hole_ray_tracing_colab.ipynb)
- **Automated Runner**: `python colab_runner.py --test`
